...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-14 09:01`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/867a009c-36dc-4a74-b6cc-2852fdfe50c0.git
$ cd 867a009c-36dc-4a74-b6cc-2852fdfe50c0
```
